...
class Servers (models.Model):
    ...
    public_ip = models.GenericIPAddressField(max_length=60, verbose_name='公网ip',  protocol='ipv4')
    private_ip = models.GenericIPAddressField(max_length=60, verbose_name='内网ip', help_text=u'必填',unique='true', protocol='ipv4')
    os = models.CharField(max_length=40, verbose_name='操作系统', default='Centos6.4')
    ...
    disk_volume = models.CharField(max_length=60,verbose_name='硬盘容量', null='true',blank='true')
